...
SERVICE_EFFECT_SET64 = "effect_set64"
...
LIFX_EFFECT_SET64_SCHEMA = cv.make_entity_service_schema(
    {
        **LIFX_EFFECT_SCHEMA,
        vol.Exclusive(ATTR_THEME, COLOR_GROUP): vol.Optional(
            vol.In(ThemeLibrary().themes)
        ...
        ATTR_BRIGHTNESS: vol.All(vol.Coerce(int), vol.Range(min=0, max=255)),
    }
)
...
class LIFXManager:
    ...
    def async_setup(self) -> None:
        ...
        self.hass.services.async_register(
            ...
            service_handler,
            schema=LIFX_EFFECT_SET64_SCHEMA,
        )
    ...
    async def start_effect(
        ...
        elif service == SERVICE_EFFECT_SET64:
