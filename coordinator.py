...
from custom_components.lifx_joy.aiolifx2.aiolifx import (
    Light,
    Message,
    MultiZoneDirection,
    MultiZoneEffectType,
...
from custom_components.lifx_joy.aiolifx2.connection import LIFXConnection
